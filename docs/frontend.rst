...
The checkout component renders a table of information gathered from a :wepay:`checkout find` call which includes:
    ...
    - Amount
    - Gross Amount
        * the amount + any additional fees that they *payer* had to pay
    - Payer Email
    - Payer Name
    - Payment Method ID
...
The checkout component is also currently responsible for rendering the information for the Payer Object.  The two are closely related, and we were able to leverage the checkout's layout for the Payer object.
